...
public class TypeUtils {
    public static boolean isTextType(String type) {
        return type.equals("String") || type.equals("Text") || type.equals("Character") || type.equals("CharSequence");
    }
    ...
    public static boolean isCollectionType(String type) {
        return type.equals("List") || type.equals("Set") || type.equals("Map") || type.equals("Collection")
                || type.equals("String[]") || type.equals("Text[]") || type.equals("List[]") || type.equals("Set[]")
                || type.equals("Map[]") || type.equals("Character[]") || type.equals("CharSequence[]")
